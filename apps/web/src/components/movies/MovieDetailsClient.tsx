        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-4 pb-10 flex flex-col md:flex-row items-end gap-8">
          ...
          <div className="flex-1 pb-4">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm font-medium text-gray-300">
              <span className="flex items-center gap-1 bg-white/10 px-3 py-1 rounded-full backdrop-blur-md border border-white/5">
                ⭐ <span className="text-white font-bold">{movie.rating}</span> / 100
              </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-12">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed text-lg">{movie.summary}</p>
            </section>
                ...
                <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
                  {(movie.cast || []).map((actor) => (
                    <article
                      ...
                      className="rounded-xl border border-white/10 bg-[#121212] p-3 shadow-lg"
                    >
                      <img
                      ...
                      />
                      <p className="text-sm font-semibold text-white truncate" title={actor.name}>{actor.name}</p>
            ...
            <section className="mt-16 pt-10 border-t border-white/10">
              ...
              <p className="text-gray-400 mb-8">Comparte tu crítica sobre {movie.title}</p>
              ...
              <div className="bg-[#121212] p-6 rounded-2xl border border-white/5 shadow-2xl">
                ...
                <div className="flex gap-4 mb-8">
                  ...
                  <div className="flex-1">
                    <textarea 
                      className="w-full bg-[#1a1a1a] text-white p-4 rounded-xl border border-white/10 focus:border-red-500 focus:outline-none resize-none"
                      rows={3}
                  ...
                  <div className="flex gap-4 border-t border-white/5 pt-6">
                    ...
                    <div>
                        <div className="flex items-center gap-3 mb-1">
                          ...
                          <span className="text-xs bg-white/10 px-2 py-0.5 rounded text-white border border-white/5">⭐ 90/100</span>
                          <span className="text-xs text-gray-500">Hace 5 horas</span>
                        </div>
                        <p className="text-gray-300">La cinematografía y la banda sonora están a otro nivel. El director supo exactamente cómo mantener la tensión de principio a fin. Directo a mi top del año.</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <aside className="space-y-8 bg-[#121212] p-6 rounded-2xl border border-white/5 h-fit shadow-2xl">
            <div>
              <h3 className="text-sm uppercase tracking-widest text-gray-500 mb-3 font-bold">
                Géneros
              </h3>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-300">
                <li>
                  ...
                  <span className="font-semibold text-white">{movie.originalTitle || movie.title}</span>
                </li>
                <li>
                ...
                <li>
                  <span className="text-gray-500 block mb-1">Presupuesto:</span>
                  {formattedBudget}
                </li>
                <li>
                  <span className="text-gray-500 block mb-1">Recaudación:</span>
                  {formattedRevenue}
                </li>
              </ul>
            </div>
